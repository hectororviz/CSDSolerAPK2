...
class SabadoTablesScreen extends StatefulWidget {
  const SabadoTablesScreen({super.key});

  @override
  State<SabadoTablesScreen> createState() => _SabadoTablesScreenState();
}
...
class _SabadoTablesScreenState extends State<SabadoTablesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: RedAppBar(
        title: 'Tablas F. Infantil - Sabados',
        context: context,
      ),
      body: _loading
